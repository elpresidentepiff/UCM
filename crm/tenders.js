...
const initialRecords = [
  ...
  record("pfh", "Procurement for Housing", "housing", "Social-housing supplier and DPS opportunities", "Supplier application, then relevant DPS/PQQ or framework competition", "Multiple; no guaranteed work", 1, "not-started", "not-started", "PfH supplier team", "info@pfh.co.uk", "https://www.procurementforhousing.co.uk/suppliers/", "https://www.procurementforhousing.co.uk/suppliers/", "Applied 27 Jul 2026", "Monitor for PfH acknowledgement and confirm whether UCM must complete an InTend PQQ for an open DPS or wait for a relevant cleaning/property-services procurement.", ["Supplier profile", "Housing capability", "Insurance", "Health and safety", "References", "Social value"], "UCM submitted a supplier application to Procurement for Housing on 27 July 2026. This records supplier interest only; framework appointments remain competitive and closed frameworks do not reopen until their next procurement."),
...
const confirmedProgress = {
  ...
  pfh: {
    ...
    application: "submitted",
    lastContacted: "2026-07-27",
    nextAction: "Monitor for PfH acknowledgement and confirm whether UCM must complete an InTend PQQ for an open DPS or wait for a relevant cleaning/property-services procurement.",
    previousNextActions: [],
    activity: [
      { date: "2026-07-27", action: "Supplier application submitted", note: "Procurement for Housing application awaiting acknowledgement and route instructions" }
    ]
  },
  "morgan-sindall": {
